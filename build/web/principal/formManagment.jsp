    ...
    <body id="body">
        ...
        <div id="all">
            ...
            <div class="container">
                ...
                <button type="button" class="btn btn-outline-secondary btn-md" data-toggle="modal" data-target="#myModal"> Nuevo Campo</button>
                <!-- edicion de texto y campos -->
                <div class="espacioForm" id="espacioForm" contenteditable="true">

                </div>
                <!-- footer -->
                <span>
                    <button class="left js-boton btn-danger btn-lg"><i class="far fa-window-close"></i>Cancelar</button>
                </span>

                <span class="cbtn">
                    <button onclick="saveForm()" id="btn-guardar" class="right js-boton btn-primary btn-lg"><i
                            class="far fa-save"></i>Guardar</button>
                </span>
                <span class="cbtn">
                    <button onclick="showPDF()" id="btn-guardar" class="right js-boton btn btn-outline-secondary btn-lg"><i
                            class="far fa-save"></i>Ver PDF</button>
                </span>
