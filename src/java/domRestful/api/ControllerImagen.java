...
import Smart_msph.data.sql;
import Smart_msph.data.ImagenDAO;
...
public class ControllerImagen extends HttpServlet {
    ...
    public static final String lIST_STUDENT = "/Smart-msph/principal/Pagina1.jsp";
    public static final String INSERT_OR_EDIT = "/Smart-msph/principal/Pagina2.jsp";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        sql auto = new sql();
        int nuevoid = auto.auto_increm("SELECT MAX(id) FROM news;");
